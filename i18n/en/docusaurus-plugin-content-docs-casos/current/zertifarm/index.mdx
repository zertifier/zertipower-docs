  ...
  <div className="row">
      ...
      <div className="card">
        ...
        <div className="card__footer">
          <div className="button-group button-group--block">
            ...
            <Link className="button button--secondary" to="/algoritmos/zertifarm/terrain-lab">Algorithm</Link>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="col col--12 margin-bottom--lg">
        <div className="card">
            ...
            <div className="card__footer">
                <div className="button-group button-group--block">
                     <Link className="button button--secondary margin-left--sm" to="/algoritmos/zertifarm/structural-analyzer">Algorithm</Link>
                </div>
            </div>
        </div>
    </div>
    ...
    <div className="col col--12 margin-bottom--lg">
        <div className="card">
            ...
            <div className="card__footer">
                 <div className="button-group button-group--block">
                     <Link className="button button--secondary margin-left--sm" to="/algoritmos/zertifarm/survey-insight">Algorithm</Link>
                </div>
            </div>
        </div>
    </div>
